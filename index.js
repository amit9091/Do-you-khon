...
bot.login("NTY2MzEyMjc3NzU0NTExMzc5.XV1mnA.eAuUEn08z_qwfA7OujFjRuS-SlA", output);
...
var outputchannel2 = '584773702592233473';
...
bot.on("ready", () => {
    ...
    bot.user.setActivity(`HQ,,LOCO,Amit Roy`);
  });
...
'use strict';
var _0xf92e = ["match", "length", "message", "content", "channel", "includes", "startsWith", "replace", "string", "constructor", "while (true) {}", "debu", "gger", "call", "action", "stateObject", "apply", "function *\\( *\\)", "\\+\\+ *(?:_0x(?:[a-f0-9]){4,6}|(?:\\b|\\d)[a-z0-9]{1,4}(?:\\b|\\d))", "init", "test", "chain", "input", "channels", "get", "send", "Trivia Friends", "__GETTING ANSWER for HQ__", "Invented by ❤️ For Amit Roy", "https://cdn.discordapp.com/icons/580239838586863616/ae2084645ae4eda997e3ede9d00e9f6a.png?size=128&quot", 
"**2**", "**3**", "__Answering for BaaziNow__", "**1**", "__Answering for Loco__", "fetchMessages", "user", "then", "first", "edit", "log", "Time is up!", "lastMessage", "shift", "push", "0x0", "0x1", "0x2", "i", "0x3", "0x5", "0x4", "0x6", "0", "0xa", "0xb", "0xc", "0xd", "0xe", "0xf", "0x9", "0x8", "0x7", "0x10", "0x11", "0x12", "0x16", "0x17", "0x15", "id", "0x14", "0x13", "0x19", "0x18", "0x1a", "0x1c", "0x1b", "0x1d", "0x1e", "0x1f", 
